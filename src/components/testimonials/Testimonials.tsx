    ...
    <section id="testimonials" className="scroll-mt-20 pt-5 md:pt-8 lg:pt-12 pb-5 md:pb-8 lg:pb-12 border-b border-gray-100">
      <div className="max-w-7xl mx-auto px-6 md:px-8">
        <div className="text-center max-w-2xl mx-auto mb-10 md:mb-14 space-y-3">
          ...
          <h2 className="text-3xl sm:text-4xl font-bold text-secondary">What Our Clients Say</h2>
        ...
        <p className="text-center text-xs font-semibold tracking-wide text-gray-500 uppercase mt-10 flex items-center justify-center gap-2">
