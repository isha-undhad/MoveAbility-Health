        ...
        <a href="#home" className="flex items-center gap-3 shrink-0" aria-label="MoveAbility Health home">
          ...
          <span className="flex flex-col justify-center">
            <span className="flex flex-col items-center">
              ...
              <span className="mt-1 text-[10px] sm:text-xs font-semibold leading-none tracking-wide text-secondary whitespace-nowrap">
                — HEALTH —
              </span>
            </span>
            <span className="mt-1 text-[10px] leading-tight tracking-wide text-secondary/70 font-medium whitespace-nowrap">
