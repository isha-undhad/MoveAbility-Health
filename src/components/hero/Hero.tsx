...
export default function Hero() {
  return (
    <section
      id="home"
      className="scroll-mt-20 pt-10 md:pt-12 lg:pt-16 pb-10 md:pb-16 lg:pb-20"
    >
      <div id="about" className="scroll-mt-24 max-w-7xl mx-auto px-6 md:px-8 grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        <HeroContent />
        <HeroImage
